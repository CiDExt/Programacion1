...
# :::::{important} ¿Cuándo se utiliza?
# 
# Cuando nuestra función tiene una gran cantidad de tareas para abordar.
# 
# ````{tabbed} ¿En qué consiste?
# 
# :::{admonition} Aprendamos...
# :class: tip
# Distribuir todas las tareas en funciones con tareas específicas, con una menor cantidad de código.
# :::
# ````
# 
# ````{tabbed} ¿Para qué?
...
# :::{admonition} Aprendamos...
# :class: tip
# Para que podamos identificar los fallos en alguna parte del código de manera más eficiente y también para hacer mucho más fácil la lectura del código para otros e incluso para nosotros mismos.
# :::
# ````
# 
# :::::
